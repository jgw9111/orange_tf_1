...
#스케일링은 선형분석을 적용하여 전체 자료의 분포를 평균0, 분산1이 되도록 만드는 과정
...
df_cctv_pop= pd.read_csv(ctx+'cctv_pop.csv',encoding='utf-8',index_col='구별')
...
df_police_norm_sort = df_police_norm\
    .sort_values(by='검거',ascending=False)
